...
<footer id="footer" data-footer>
	<div class="footer-section">
		...
		<ul class="footer-social">
			...
			<li><a href="http://www.linkedin.com/company/buffini-and-company" class="icon-social" title="LinkedIn"><svg viewBox="0 0 512 512"><path d="M186.4 142.4c0 19-15.3 34.5-34.2 34.5 -18.9 0-34.2-15.4-34.2-34.5 0-19 15.3-34.5 34.2-34.5C171.1 107.9 186.4 123.4 186.4 142.4zM181.4 201.3h-57.8V388.1h57.8V201.3zM273.8 201.3h-55.4V388.1h55.4c0 0 0-69.3 0-98 0-26.3 12.1-41.9 35.2-41.9 21.3 0 31.5 15 31.5 41.9 0 26.9 0 98 0 98h57.5c0 0 0-68.2 0-118.3 0-50-28.3-74.2-68-74.2 -39.6 0-56.3 30.9-56.3 30.9v-25.2H273.8z"></path></svg><!--[if lt IE 9]>LinkedIn<![endif]--></a></li>
			<li><a href="http://pinterest.com/buffiniandco" class="icon-social" title="Pinterest"><svg viewBox="0 0 512 512"><path d="M266.6 76.5c-100.2 0-150.7 71.8-150.7 131.7 0 36.3 13.7 68.5 43.2 80.6 4.8 2 9.2 0.1 10.6-5.3 1-3.7 3.3-13 4.3-16.9 1.4-5.3 0.9-7.1-3-11.8 -8.5-10-13.9-23-13.9-41.3 0-53.3 39.9-101 103.8-101 56.6 0 87.7 34.6 87.7 80.8 0 60.8-26.9 112.1-66.8 112.1 -22.1 0-38.6-18.2-33.3-40.6 6.3-26.7 18.6-55.5 18.6-74.8 0-17.3-9.3-31.7-28.4-31.7 -22.5 0-40.7 23.3-40.7 54.6 0 19.9 6.7 33.4 6.7 33.4s-23.1 97.8-27.1 114.9c-8.1 34.1-1.2 75.9-0.6 80.1 0.3 2.5 3.6 3.1 5 1.2 2.1-2.7 28.9-35.9 38.1-69 2.6-9.4 14.8-58 14.8-58 7.3 14 28.7 26.3 51.5 26.3 67.8 0 113.8-61.8 113.8-144.5C400.1 134.7 347.1 76.5 266.6 76.5z"></path></svg><!--[if lt IE 9]>Pinterest<![endif]--></a></li>
		</ul>
	</div>
	<hr>
	<div class="footer-section">
		<ul class="footer-links footer-links-primary">
			<li><a href="http://www.buffiniandcompany.com/sitemap.aspx">Site Map</a></li>
			<li><a href="http://www.buffiniandcompany.com/about-buffini-and-company.aspx">About Us</a></li>
			<li><a href="http://www.buffiniandcompany.com/contact-buffini-and-company.aspx">Contact Us</a></li>
		</ul>
		<ul class="footer-links footer-links-secondary">
			<li><a href="http://www.buffiniandcompany.com/company/privacy-policy.aspx">Privacy</a></li>
			<li><a href="http://www.buffiniandcompany.com/termsofuse">Terms</a></li>
			<li><span>&copy; <?php echo date('Y'); ?> Buffini &amp; Company.</span></li>
		</ul>
	</div>
</footer>
